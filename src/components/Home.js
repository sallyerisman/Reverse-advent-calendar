	...
	return (
		<Row className="page-content">
			<Col className="home-page-text" md={{ span: 9}} lg={{ span: 8}}>	
				<Link className="link title-link" to='/donera'><h1>Bakvänd adventskalender</h1></Link> 
				...
				<p>För att se våra största behov just nu och för att börja donera, klicka <Link className="link text-link" to='/donera'>här.</Link></p>
			</Col>
		</Row>
	)
}
